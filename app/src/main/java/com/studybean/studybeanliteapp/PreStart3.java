...
public class PreStart3 extends AppCompatActivity {
    ...
    int i,totalCorrectAnswer, progress,clickGo=0,lim;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnPlay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    Intent intent = new Intent(PreStart3.this,Start.class);
                    intent.putExtra("i",i);
        ...
        btnPlay2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(Common.questionList.size()!=0&&clickGo==0)
                {
                    Intent intent = new Intent(PreStart3.this,StartPrac.class);
                    intent.putExtra("i",i);
                    intent.putExtra("totalCorrectAnswer",totalCorrectAnswer);
                    finish();
                    startActivity(intent);
        ...
        questions.orderByChild("CategoryId").equalTo(categoryId)
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        Intent intent = new Intent(PreStart3.this,Start3.class);
                        intent.putExtra("i",i);
                        intent.putExtra("ps",ps);
